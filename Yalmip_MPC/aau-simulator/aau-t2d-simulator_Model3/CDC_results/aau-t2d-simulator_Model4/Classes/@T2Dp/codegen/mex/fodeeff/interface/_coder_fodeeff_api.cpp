...
static real_T (*d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *basal,
                                   ...
                                   const char_T *identifier))[15]
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = d_emlrt_marshallIn(sp, emlrtAlias(basal), &thisId);
...
void fodeeff_api(const mxArray *const prhs[5], const mxArray **plhs)
{
  ...
  param = c_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "param");
  basal = d_emlrt_marshallIn(&st, emlrtAlias(prhs[4]), "basal");
...
// End of code generation (_coder_fodeeff_api.cpp)
