...
function dx=fodeeff(obj,t, x, DgA, param, basal)
...
%% Vildagliptin submodel:
 ...
 %% GLP-1 agonists 
    ...
    %(Exenatide):
    dx(70) = -ah2*psih2;
    dx(71) = bh2*ah2*psih2 - bh2*PSIh2;

    
    %(Semaglutide):
    dx(72) = -ah24*psih24;
    dx(73) = bh24*ah24*psih24 - bh24*PSIh24;
