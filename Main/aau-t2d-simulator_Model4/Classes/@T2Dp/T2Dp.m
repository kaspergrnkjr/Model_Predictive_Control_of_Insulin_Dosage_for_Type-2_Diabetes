...
classdef T2Dp < handle
   ...
   %Simulation parameters:
        Nd = 1 %Number of simulation days
   ...
   methods
      ...
      function Nminv = get.Nmin(obj)
         Nminv = floor(obj.Nd*(obj.dt*24*60));
      end
